...
PROTOBUF_NAMESPACE_OPEN
template<> ::SnowK::EchoRequest* Arena::CreateMaybeMessage<::SnowK::EchoRequest>(Arena*);
template<> ::SnowK::EchoResponse* Arena::CreateMaybeMessage<::SnowK::EchoResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace SnowK {
...
class EchoRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SnowK.EchoRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:SnowK.EchoRequest)
 private:
  class _Internal;
...
class EchoResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SnowK.EchoResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:SnowK.EchoResponse)
 private:
  class _Internal;
...
inline const std::string& EchoRequest::message() const {
  // @@protoc_insertion_point(field_get:SnowK.EchoRequest.message)
...
void EchoRequest::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:SnowK.EchoRequest.message)
}
inline std::string* EchoRequest::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:SnowK.EchoRequest.message)
  return _s;
}
...
inline std::string* EchoRequest::release_message() {
  // @@protoc_insertion_point(field_release:SnowK.EchoRequest.message)
...
inline void EchoRequest::set_allocated_message(std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:SnowK.EchoRequest.message)
}
...
inline const std::string& EchoResponse::message() const {
  // @@protoc_insertion_point(field_get:SnowK.EchoResponse.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void EchoResponse::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:SnowK.EchoResponse.message)
}
inline std::string* EchoResponse::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:SnowK.EchoResponse.message)
  return _s;
}
...
inline std::string* EchoResponse::release_message() {
  // @@protoc_insertion_point(field_release:SnowK.EchoResponse.message)
  return _impl_.message_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:SnowK.EchoResponse.message)
}
