...
static const ::_pb::ServiceDescriptor* file_level_service_descriptors_main_2eproto[1];

const uint32_t TableStruct_main_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::SnowK::EchoRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::SnowK::EchoRequest, _impl_.message_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::SnowK::EchoResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::SnowK::EchoResponse, _impl_.message_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::SnowK::EchoRequest)},
  { 7, -1, -1, sizeof(::SnowK::EchoResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::SnowK::_EchoRequest_default_instance_._instance,
  &::SnowK::_EchoResponse_default_instance_._instance,
};

const char descriptor_table_protodef_main_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nmain.proto\022\005SnowK\"\036\n\013EchoRequest\022\017\n\007me"
  "ssage\030\001 \001(\t\"\037\n\014EchoResponse\022\017\n\007message\030\001"
  " \001(\t2>\n\013EchoService\022/\n\004Echo\022\022.SnowK.Echo"
  "Request\032\023.SnowK.EchoResponseB\003\200\001\001b\006proto"
  "3"
  ;
static ::_pbi::once_flag descriptor_table_main_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_main_2eproto = {
    false, false, 161, descriptor_table_protodef_main_2eproto,
    "main.proto",
...
EchoRequest::EchoRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:SnowK.EchoRequest)
}
EchoRequest::EchoRequest(const EchoRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:SnowK.EchoRequest)
}
...
EchoRequest::~EchoRequest() {
  // @@protoc_insertion_point(destructor:SnowK.EchoRequest)
...
// @@protoc_insertion_point(message_clear_start:SnowK.EchoRequest)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "SnowK.EchoRequest.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* EchoRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:SnowK.EchoRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:SnowK.EchoRequest)
  return target;
}

size_t EchoRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:SnowK.EchoRequest)
  size_t total_size = 0;
...
void EchoRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:SnowK.EchoRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:SnowK.EchoRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
EchoResponse::EchoResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:SnowK.EchoResponse)
}
EchoResponse::EchoResponse(const EchoResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:SnowK.EchoResponse)
}
...
EchoResponse::~EchoResponse() {
  // @@protoc_insertion_point(destructor:SnowK.EchoResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:SnowK.EchoResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "SnowK.EchoResponse.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* EchoResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:SnowK.EchoResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:SnowK.EchoResponse)
  return target;
}

size_t EchoResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:SnowK.EchoResponse)
  size_t total_size = 0;
...
void EchoResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:SnowK.EchoResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:SnowK.EchoResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* EchoService::descriptor() {
  ...
  return file_level_service_descriptors_main_2eproto[0];
}
...
void EchoService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_main_2eproto[0]);
  switch(method->index()) {
    case 0:
      Echo(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::SnowK::EchoRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::SnowK::EchoResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& EchoService::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::SnowK::EchoRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& EchoService::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::SnowK::EchoResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::SnowK::EchoRequest*
Arena::CreateMaybeMessage< ::SnowK::EchoRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::SnowK::EchoRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::SnowK::EchoResponse*
Arena::CreateMaybeMessage< ::SnowK::EchoResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::SnowK::EchoResponse >(arena);
}
