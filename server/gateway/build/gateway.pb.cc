...
const uint32_t TableStruct_gateway_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::SnowK::ClientAuthenticationReq, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::SnowK::ClientAuthenticationReq, _impl_.request_id_),
  PROTOBUF_FIELD_OFFSET(::SnowK::ClientAuthenticationReq, _impl_.session_id_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::SnowK::ClientAuthenticationReq)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::SnowK::_ClientAuthenticationReq_default_instance_._instance,
};

const char descriptor_table_protodef_gateway_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rgateway.proto\022\005SnowK\"A\n\027ClientAuthenti"
  "cationReq\022\022\n\nrequest_id\030\001 \001(\t\022\022\n\nsession"
  "_id\030\002 \001(\tB\003\200\001\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_gateway_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_gateway_2eproto = {
    false, false, 102, descriptor_table_protodef_gateway_2eproto,
    "gateway.proto",
...
ClientAuthenticationReq::ClientAuthenticationReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:SnowK.ClientAuthenticationReq)
}
ClientAuthenticationReq::ClientAuthenticationReq(const ClientAuthenticationReq& from)
  ...
  // @@protoc_insertion_point(copy_constructor:SnowK.ClientAuthenticationReq)
}
...
ClientAuthenticationReq::~ClientAuthenticationReq() {
  // @@protoc_insertion_point(destructor:SnowK.ClientAuthenticationReq)
...
// @@protoc_insertion_point(message_clear_start:SnowK.ClientAuthenticationReq)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "SnowK.ClientAuthenticationReq.request_id"));
        } else
          goto handle_unusual;
        continue;
      // string session_id = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "SnowK.ClientAuthenticationReq.session_id"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* ClientAuthenticationReq::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:SnowK.ClientAuthenticationReq)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_request_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "SnowK.ClientAuthenticationReq.request_id");
  ...
  if (!this->_internal_session_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "SnowK.ClientAuthenticationReq.session_id");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:SnowK.ClientAuthenticationReq)
  return target;
}

size_t ClientAuthenticationReq::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:SnowK.ClientAuthenticationReq)
  size_t total_size = 0;
...
void ClientAuthenticationReq::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:SnowK.ClientAuthenticationReq)
...
// @@protoc_insertion_point(class_specific_copy_from_start:SnowK.ClientAuthenticationReq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::SnowK::ClientAuthenticationReq*
Arena::CreateMaybeMessage< ::SnowK::ClientAuthenticationReq >(Arena* arena) {
  return Arena::CreateMessageInternal< ::SnowK::ClientAuthenticationReq >(arena);
}
