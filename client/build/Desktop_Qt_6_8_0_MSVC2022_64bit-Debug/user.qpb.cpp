...
public:
    ...
    QString m_nickname;
    QString m_password;
    std::optional<QString> m_verifyCodeId;
    std::optional<QString> m_verifyCode;
};
...
static constexpr struct {
    ...
    const char qt_protobuf_UserRegisterReq_char_data[75];
    ...
    // uint_data
    {
        ...
        uint(QtProtobufPrivate::FieldFlag::Optional | QtProtobufPrivate::FieldFlag::ExplicitPresence), /* = verifyCodeId */
        uint(QtProtobufPrivate::FieldFlag::Optional | QtProtobufPrivate::FieldFlag::ExplicitPresence), /* = verifyCode */
    },
    // char_data
    /* metadata char_data: */
    "SnowK.UserRegisterReq\0" /* = full message name */
    /* field char_data: */
...
QString UserRegisterReq::verifyCodeId_p() const
{
    return dptr->m_verifyCodeId ?
        dptr->m_verifyCodeId.value() : QString();
}

bool UserRegisterReq::hasVerifyCodeId() const
{
    return dptr->m_verifyCodeId.has_value();
}
QString UserRegisterReq::verifyCodeId() const
{
    Q_ASSERT(dptr->m_verifyCodeId.has_value());
    return dptr->m_verifyCodeId.value();
}

QString UserRegisterReq::verifyCode_p() const
{
    return dptr->m_verifyCode ?
        dptr->m_verifyCode.value() : QString();
}

bool UserRegisterReq::hasVerifyCode() const
{
    return dptr->m_verifyCode.has_value();
}
QString UserRegisterReq::verifyCode() const
{
    Q_ASSERT(dptr->m_verifyCode.has_value());
    return dptr->m_verifyCode.value();
}
...
{
    if (!dptr->m_verifyCodeId || dptr->m_verifyCodeId.value() != verifyCodeId) {
        dptr.detach();
...
void UserRegisterReq::setVerifyCodeId_p(QString verifyCodeId)
{
    if (!dptr->m_verifyCodeId || dptr->m_verifyCodeId != verifyCodeId) {
        dptr.detach();
        dptr->m_verifyCodeId = verifyCodeId;
    }
}

void UserRegisterReq::clearVerifyCodeId()
{
    if (dptr->m_verifyCodeId.has_value()) {
        dptr.detach();
        dptr->m_verifyCodeId.reset();
    }
}
void UserRegisterReq::setVerifyCode(const QString &verifyCode)
{
    if (!dptr->m_verifyCode || dptr->m_verifyCode.value() != verifyCode) {
        dptr.detach();
...
void UserRegisterReq::setVerifyCode_p(QString verifyCode)
{
    if (!dptr->m_verifyCode || dptr->m_verifyCode != verifyCode) {
        dptr.detach();
        dptr->m_verifyCode = verifyCode;
    }
}

void UserRegisterReq::clearVerifyCode()
{
    if (dptr->m_verifyCode.has_value()) {
        dptr.detach();
        dptr->m_verifyCode.reset();
    }
}
...
static constexpr struct {
    ...
    const char qt_protobuf_UserRegisterRsp_char_data[48];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.UserRegisterRsp\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_UserLoginReq_char_data[72];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.UserLoginReq\0" /* = full message name */
    /* field char_data: */
    "requestId\0nickname\0password\0verifyCodeId\0verifyCode\0"
};
...
QString UserLoginReq::verifyCodeId_p() const
{
    return dptr->m_verifyCodeId ?
        dptr->m_verifyCodeId.value() : QString();
}

bool UserLoginReq::hasVerifyCodeId() const
{
    return dptr->m_verifyCodeId.has_value();
}
...
QString UserLoginReq::verifyCode_p() const
{
    return dptr->m_verifyCode ?
        dptr->m_verifyCode.value() : QString();
}

bool UserLoginReq::hasVerifyCode() const
{
    return dptr->m_verifyCode.has_value();
}
...
void UserLoginReq::setVerifyCodeId_p(QString verifyCodeId)
{
    if (!dptr->m_verifyCodeId || dptr->m_verifyCodeId != verifyCodeId) {
        dptr.detach();
        dptr->m_verifyCodeId = verifyCodeId;
...
void UserLoginReq::clearVerifyCodeId()
{
    if (dptr->m_verifyCodeId.has_value()) {
        dptr.detach();
        dptr->m_verifyCodeId.reset();
...
void UserLoginReq::setVerifyCode_p(QString verifyCode)
{
    if (!dptr->m_verifyCode || dptr->m_verifyCode != verifyCode) {
        dptr.detach();
        dptr->m_verifyCode = verifyCode;
...
void UserLoginReq::clearVerifyCode()
{
    if (dptr->m_verifyCode.has_value()) {
        dptr.detach();
        dptr->m_verifyCode.reset();
...
static constexpr struct {
    ...
    const char qt_protobuf_UserLoginRsp_char_data[60];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.UserLoginRsp\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_PhoneVerifyCodeReq_char_data[48];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.PhoneVerifyCodeReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_PhoneVerifyCodeRsp_char_data[64];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.PhoneVerifyCodeRsp\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_PhoneRegisterReq_char_data[70];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.PhoneRegisterReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_PhoneRegisterRsp_char_data[49];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.PhoneRegisterRsp\0" /* = full message name */
    /* field char_data: */
    "requestId\0success\0errmsg\0"
};
...
static constexpr struct {
    ...
    const char qt_protobuf_PhoneLoginReq_char_data[67];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.PhoneLoginReq\0" /* = full message name */
    /* field char_data: */
    "requestId\0phoneNumber\0verifyCodeId\0verifyCode\0"
};
...
static constexpr struct {
    ...
    const char qt_protobuf_PhoneLoginRsp_char_data[61];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.PhoneLoginRsp\0" /* = full message name */
    /* field char_data: */
    "requestId\0success\0errmsg\0loginSessionId\0"
};
...
static constexpr struct {
    ...
    const char qt_protobuf_GetUserInfoReq_char_data[49];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetUserInfoReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_GetUserInfoRsp_char_data[56];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetUserInfoRsp\0" /* = full message name */
    /* field char_data: */
...
class GetMultiUserInfoReq_QtProtobufData : public QSharedData
{
public:
    GetMultiUserInfoReq_QtProtobufData()
        : QSharedData()
    {
    }

    GetMultiUserInfoReq_QtProtobufData(const GetMultiUserInfoReq_QtProtobufData &other)
        : QSharedData(other),
          m_requestId(other.m_requestId),
          m_usersId(other.m_usersId)
    {
    }

    QString m_requestId;
    QStringList m_usersId;
};

GetMultiUserInfoReq::~GetMultiUserInfoReq() = default;

static constexpr struct {
    QtProtobufPrivate::QProtobufPropertyOrdering::Data data;
    const std::array<uint, 9> qt_protobuf_GetMultiUserInfoReq_uint_data;
    const char qt_protobuf_GetMultiUserInfoReq_char_data[45];
} qt_protobuf_GetMultiUserInfoReq_metadata {
    // data
    {
        0, /* = version */
        2, /* = num fields */
    ...
    // uint_data
    {
        ...
        // Field flags:
        uint(QtProtobufPrivate::FieldFlag::NoFlags), /* = requestId */
        uint(QtProtobufPrivate::FieldFlag::Repeated), /* = usersId */
    },
    // char_data
    /* metadata char_data: */
    "SnowK.GetMultiUserInfoReq\0" /* = full message name */
    /* field char_data: */
    "requestId\0usersId\0"
};

const QtProtobufPrivate::QProtobufPropertyOrdering GetMultiUserInfoReq::staticPropertyOrdering = {
    &qt_protobuf_GetMultiUserInfoReq_metadata.data
};

void GetMultiUserInfoReq::registerTypes()
{
    qRegisterMetaType<GetMultiUserInfoReq>();
    qRegisterMetaType<GetMultiUserInfoReqRepeated>();
}

GetMultiUserInfoReq::GetMultiUserInfoReq()
    : QProtobufMessage(&GetMultiUserInfoReq::staticMetaObject, &GetMultiUserInfoReq::staticPropertyOrdering),
      dptr(new GetMultiUserInfoReq_QtProtobufData)
{
}

GetMultiUserInfoReq::GetMultiUserInfoReq(const GetMultiUserInfoReq &other)
    = default;
GetMultiUserInfoReq &GetMultiUserInfoReq::operator =(const GetMultiUserInfoReq &other)
{
    GetMultiUserInfoReq temp(other);
    swap(temp);
    return *this;
}
GetMultiUserInfoReq::GetMultiUserInfoReq(GetMultiUserInfoReq &&other) noexcept
    = default;
bool comparesEqual(const GetMultiUserInfoReq &lhs, const GetMultiUserInfoReq &rhs) noexcept
{
    return operator ==(static_cast<const QProtobufMessage&>(lhs),
                       static_cast<const QProtobufMessage&>(rhs))
        && lhs.dptr->m_requestId == rhs.dptr->m_requestId
        && lhs.dptr->m_usersId == rhs.dptr->m_usersId;
}

const QString &GetMultiUserInfoReq::requestId() const &
{
    return dptr->m_requestId;
}

const QStringList &GetMultiUserInfoReq::usersId() const &
{
    return dptr->m_usersId;
}

void GetMultiUserInfoReq::setRequestId(const QString &requestId)
{
    if (dptr->m_requestId != requestId) {
        dptr.detach();
        dptr->m_requestId = requestId;
...
void GetMultiUserInfoReq::setRequestId(QString &&requestId)
{
    if (dptr->m_requestId != requestId) {
        dptr.detach();
        dptr->m_requestId = std::move(requestId);
...
void GetMultiUserInfoReq::setUsersId(const QStringList &usersId)
{
    if (dptr->m_usersId != usersId) {
        dptr.detach();
        dptr->m_usersId = usersId;
    }
}

void GetMultiUserInfoReq::setUsersId(QStringList &&usersId)
{
    if (dptr->m_usersId != usersId) {
        dptr.detach();
        dptr->m_usersId = std::move(usersId);
    }
}


class GetMultiUserInfoRsp_QtProtobufData : public QSharedData
{
public:
    GetMultiUserInfoRsp_QtProtobufData()
        : QSharedData(),
          m_success(false)
    {
    }

    GetMultiUserInfoRsp_QtProtobufData(const GetMultiUserInfoRsp_QtProtobufData &other)
        : QSharedData(other),
          m_requestId(other.m_requestId),
          m_success(other.m_success),
          m_errmsg(other.m_errmsg),
          m_usersInfo(other.m_usersInfo)
    {
    }
    ...
    bool m_success;
    QString m_errmsg;
    GetMultiUserInfoRsp::UsersInfoEntry m_usersInfo;
};

GetMultiUserInfoRsp::~GetMultiUserInfoRsp() = default;

static constexpr struct {
    QtProtobufPrivate::QProtobufPropertyOrdering::Data data;
    const std::array<uint, 17> qt_protobuf_GetMultiUserInfoRsp_uint_data;
    const char qt_protobuf_GetMultiUserInfoRsp_char_data[62];
} qt_protobuf_GetMultiUserInfoRsp_metadata {
    // data
    {
        0, /* = version */
        4, /* = num fields */
    ...
    // uint_data
    {
        ...
        uint(QtProtobufPrivate::FieldFlag::NoFlags), /* = success */
        uint(QtProtobufPrivate::FieldFlag::NoFlags), /* = errmsg */
        uint(QtProtobufPrivate::FieldFlag::Map | QtProtobufPrivate::FieldFlag::Message), /* = usersInfo */
    },
    // char_data
    /* metadata char_data: */
    "SnowK.GetMultiUserInfoRsp\0" /* = full message name */
    /* field char_data: */
    "requestId\0success\0errmsg\0usersInfo\0"
};

const QtProtobufPrivate::QProtobufPropertyOrdering GetMultiUserInfoRsp::staticPropertyOrdering = {
    &qt_protobuf_GetMultiUserInfoRsp_metadata.data
};

void GetMultiUserInfoRsp::registerTypes()
{
    qRegisterMetaType<GetMultiUserInfoRsp>();
    qRegisterMetaType<GetMultiUserInfoRspRepeated>();
    qRegisterMetaType<GetMultiUserInfoRsp::UsersInfoEntry>();
    qRegisterProtobufMapType<QString, UserInfo>();
}

GetMultiUserInfoRsp::GetMultiUserInfoRsp()
    : QProtobufMessage(&GetMultiUserInfoRsp::staticMetaObject, &GetMultiUserInfoRsp::staticPropertyOrdering),
      dptr(new GetMultiUserInfoRsp_QtProtobufData)
{
}

GetMultiUserInfoRsp::GetMultiUserInfoRsp(const GetMultiUserInfoRsp &other)
    = default;
GetMultiUserInfoRsp &GetMultiUserInfoRsp::operator =(const GetMultiUserInfoRsp &other)
{
    GetMultiUserInfoRsp temp(other);
    swap(temp);
    return *this;
}
GetMultiUserInfoRsp::GetMultiUserInfoRsp(GetMultiUserInfoRsp &&other) noexcept
    = default;
bool comparesEqual(const GetMultiUserInfoRsp &lhs, const GetMultiUserInfoRsp &rhs) noexcept
{
    return operator ==(static_cast<const QProtobufMessage&>(lhs),
                       static_cast<const QProtobufMessage&>(rhs))
        && lhs.dptr->m_requestId == rhs.dptr->m_requestId
        && lhs.dptr->m_success == rhs.dptr->m_success
        && lhs.dptr->m_errmsg == rhs.dptr->m_errmsg
        && lhs.dptr->m_usersInfo == rhs.dptr->m_usersInfo;
}

const QString &GetMultiUserInfoRsp::requestId() const &
{
    return dptr->m_requestId;
}

bool GetMultiUserInfoRsp::success() const
{
    return dptr->m_success;
}

const QString &GetMultiUserInfoRsp::errmsg() const &
{
    return dptr->m_errmsg;
}

const GetMultiUserInfoRsp::UsersInfoEntry &GetMultiUserInfoRsp::usersInfo() const &
{
    return dptr->m_usersInfo;
}

void GetMultiUserInfoRsp::setRequestId(const QString &requestId)
{
    if (dptr->m_requestId != requestId) {
        dptr.detach();
        dptr->m_requestId = requestId;
...
void GetMultiUserInfoRsp::setRequestId(QString &&requestId)
{
    if (dptr->m_requestId != requestId) {
        dptr.detach();
        dptr->m_requestId = std::move(requestId);
...
void GetMultiUserInfoRsp::setSuccess(bool success)
{
    if (dptr->m_success != success) {
        dptr.detach();
        dptr->m_success = success;
...
void GetMultiUserInfoRsp::setErrmsg(const QString &errmsg)
{
    if (dptr->m_errmsg != errmsg) {
        dptr.detach();
        dptr->m_errmsg = errmsg;
...
void GetMultiUserInfoRsp::setErrmsg(QString &&errmsg)
{
    if (dptr->m_errmsg != errmsg) {
        dptr.detach();
        dptr->m_errmsg = std::move(errmsg);
...
void GetMultiUserInfoRsp::setUsersInfo(const GetMultiUserInfoRsp::UsersInfoEntry &usersInfo)
{
    if (dptr->m_usersInfo != usersInfo) {
        dptr.detach();
        dptr->m_usersInfo = usersInfo;
    }
}

void GetMultiUserInfoRsp::setUsersInfo(GetMultiUserInfoRsp::UsersInfoEntry &&usersInfo)
{
    if (dptr->m_usersInfo != usersInfo) {
        dptr.detach();
        dptr->m_usersInfo = std::move(usersInfo);
    }
}
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserAvatarReq_char_data[58];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserAvatarReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserAvatarRsp_char_data[49];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserAvatarRsp\0" /* = full message name */
    /* field char_data: */
    "requestId\0success\0errmsg\0"
};
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserNicknameReq_char_data[62];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserNicknameReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserNicknameRsp_char_data[51];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserNicknameRsp\0" /* = full message name */
    /* field char_data: */
    "requestId\0success\0errmsg\0"
};
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserDescriptionReq_char_data[68];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserDescriptionReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserDescriptionRsp_char_data[54];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserDescriptionRsp\0" /* = full message name */
    /* field char_data: */
    "requestId\0success\0errmsg\0"
};
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserPhoneNumberReq_char_data[102];
    ...
    // uint_data
    {
        ...
        45, /* = sessionId */
        55, /* = phoneNumber */
        67, /* = phoneVerifyCodeId */
        85, /* = phoneVerifyCode */
        101, /* = end-of-string-marker */
        // Field numbers:
        1, /* = requestId */
        2, /* = userId */
        3, /* = sessionId */
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserPhoneNumberReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_SetUserPhoneNumberRsp_char_data[54];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.SetUserPhoneNumberRsp\0" /* = full message name */
    /* field char_data: */
    "requestId\0success\0errmsg\0"
};
