...
static constexpr struct {
    ...
    const char qt_protobuf_GetFriendListReq_char_data[51];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetFriendListReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_GetFriendListRsp_char_data[60];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetFriendListRsp\0" /* = full message name */
    /* field char_data: */
...
const UserInfoRepeated &GetFriendListRsp::friendList() const &
{
...
void GetFriendListRsp::setFriendList(UserInfoRepeated &&friendList)
{
    if (dptr->m_friendList != friendList) {
        dptr.detach();
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendRemoveReq_char_data[57];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendRemoveReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendRemoveRsp_char_data[48];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendRemoveRsp\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendAddReq_char_data[60];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendAddReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendAddRsp_char_data[59];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendAddRsp\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendAddProcessReq_char_data[86];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendAddProcessReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendAddProcessRsp_char_data[65];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendAddProcessRsp\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_GetPendingFriendEventListReq_char_data[63];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetPendingFriendEventListReq\0" /* = full message name */
    /* field char_data: */
...
public:
    ...
    std::optional<QString> m_eventId;
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendEvent_char_data[34];
    ...
    // uint_data
    {
        ...
        2, /* = sender */
        // Field flags:
        uint(QtProtobufPrivate::FieldFlag::Optional | QtProtobufPrivate::FieldFlag::ExplicitPresence), /* = eventId */
        uint(QtProtobufPrivate::FieldFlag::ExplicitPresence | QtProtobufPrivate::FieldFlag::Message), /* = sender */
    },
    // char_data
    /* metadata char_data: */
    "SnowK.FriendEvent\0" /* = full message name */
    /* field char_data: */
    "eventId\0sender\0"
};
...
QString FriendEvent::eventId_p() const
{
    return dptr->m_eventId ?
        dptr->m_eventId.value() : QString();
}

bool FriendEvent::hasEventId() const
{
    return dptr->m_eventId.has_value();
}
QString FriendEvent::eventId() const
{
    Q_ASSERT(dptr->m_eventId.has_value());
    return dptr->m_eventId.value();
}
...
{
    if (!dptr->m_eventId || dptr->m_eventId.value() != eventId) {
        dptr.detach();
...
void FriendEvent::setEventId_p(QString eventId)
{
    if (!dptr->m_eventId || dptr->m_eventId != eventId) {
        dptr.detach();
        dptr->m_eventId = eventId;
    }
}

void FriendEvent::clearEventId()
{
    if (dptr->m_eventId.has_value()) {
        dptr.detach();
        dptr->m_eventId.reset();
    }
}
...
static constexpr struct {
    ...
    const char qt_protobuf_GetPendingFriendEventListRsp_char_data[67];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetPendingFriendEventListRsp\0" /* = full message name */
    /* field char_data: */
...
const FriendEventRepeated &GetPendingFriendEventListRsp::event() const &
{
    return dptr->m_event;
}
...
void GetPendingFriendEventListRsp::setEvent(FriendEventRepeated &&event)
{
    if (dptr->m_event != event) {
        dptr.detach();
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendSearchReq_char_data[60];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendSearchReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_FriendSearchRsp_char_data[57];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.FriendSearchRsp\0" /* = full message name */
    /* field char_data: */
...
const UserInfoRepeated &FriendSearchRsp::userInfo() const &
{
...
void FriendSearchRsp::setUserInfo(UserInfoRepeated &&userInfo)
{
    if (dptr->m_userInfo != userInfo) {
        dptr.detach();
...
static constexpr struct {
    ...
    const char qt_protobuf_GetChatSessionListReq_char_data[56];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetChatSessionListReq\0" /* = full message name */
    /* field char_data: */
    "requestId\0sessionId\0userId\0"
};
...
static constexpr struct {
    ...
    const char qt_protobuf_GetChatSessionListRsp_char_data[74];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetChatSessionListRsp\0" /* = full message name */
    /* field char_data: */
...
const ChatSessionInfoRepeated &GetChatSessionListRsp::chatSessionInfoList() const &
{
...
void GetChatSessionListRsp::setChatSessionInfoList(ChatSessionInfoRepeated &&chatSessionInfoList)
{
    if (dptr->m_chatSessionInfoList != chatSessionInfoList) {
        dptr.detach();
...
static constexpr struct {
    ...
    const char qt_protobuf_ChatSessionCreateReq_char_data[84];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.ChatSessionCreateReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_ChatSessionCreateRsp_char_data[69];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.ChatSessionCreateRsp\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_GetChatSessionMemberReq_char_data[72];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetChatSessionMemberReq\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_GetChatSessionMemberRsp_char_data[71];
    ...
    // char_data
    /* metadata char_data: */
    "SnowK.GetChatSessionMemberRsp\0" /* = full message name */
    /* field char_data: */
...
const UserInfoRepeated &GetChatSessionMemberRsp::memberInfoList() const &
{
...
void GetChatSessionMemberRsp::setMemberInfoList(UserInfoRepeated &&memberInfoList)
{
    if (dptr->m_memberInfoList != memberInfoList) {
        dptr.detach();
