...
DEFINE_string(instance_name, "/transmite_service/instance", "Name of the current instance");
DEFINE_string(access_host, "127.0.0.1:10004", "The external access address of the current instance");

DEFINE_int32(listen_port, 10004, "The RPC server listens on the port");
